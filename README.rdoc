...
Cucumber localized steps I normally use on top of others e.g: cucumber default web_steps, bmabey email_steps and such.

Start new rails app using full bdd battery template, in this case giving devise as auth a try
...
Then wget the steps files using the task
